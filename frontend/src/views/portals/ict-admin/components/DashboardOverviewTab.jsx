...
=======
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 shrink-0">
        <div className="bg-white border-t-4 border-t-[#D32F2F] border-x border-b border-gray-200 p-7 rounded-xl shadow-sm flex items-center justify-between hover:shadow-md transition-all">
          <div>
            <p className="text-[10px] text-gray-500 uppercase font-black tracking-wider mb-0.5">Active Tracks</p>
            <h3 className="text-2xl font-black text-gray-900">{data.counters.activeTracks}</h3>
          </div>
          <div className="p-2.5 bg-red-50 border border-red-100 text-[#D32F2F] rounded-lg shadow-sm">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
          </div>
        </div>

        <div className="bg-white border-t-4 border-t-blue-600 border-x border-b border-gray-200 p-4 rounded-xl shadow-sm flex items-center justify-between hover:shadow-md transition-all">
          <div>
            <p className="text-[10px] text-gray-500 uppercase font-black tracking-wider mb-0.5">Registered Personnel</p>
            <h3 className="text-2xl font-black text-gray-900">{data.counters.systemUsers}</h3>
          </div>
          <div className="p-2.5 bg-blue-50 border border-blue-100 text-blue-600 rounded-lg shadow-sm">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" /></svg>
          </div>
        </div>

        <div className="bg-white border-t-4 border-t-amber-500 border-x border-b border-gray-200 p-4 rounded-xl shadow-sm flex items-center justify-between hover:shadow-md transition-all">
          <div>
            <p className="text-[10px] text-gray-500 uppercase font-black tracking-wider mb-0.5">Workflow Blueprints</p>
            <h3 className="text-2xl font-black text-gray-900">{data.counters.workflowBlueprints}</h3>
          </div>
          <div className="p-2.5 bg-amber-50 border border-amber-100 text-amber-600 rounded-lg shadow-sm">
...
=======
        ...
        <div className="w-[85vw] sm:w-80 md:w-auto md:flex-2 shrink-0 flex flex-col bg-white rounded-xl border border-gray-200 overflow-hidden transition-opacity snap-start">
          <div className="p-3 border-b border-gray-200 bg-gray-50 shrink-0">
            <h3 className="text-xs font-black text-gray-900 flex items-center gap-1.5 uppercase tracking-wide">
...
=======
          <div className="p-4 overflow-y-auto custom-scrollbar flex-1 bg-gray-50/30">
            <div className="space-y-4 relative before:absolute before:inset-0 before:ml-4 before:-translate-x-px before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-gray-300 before:to-transparent">
              {data.liveAuditTrail.map((log) => (
                <div key={log.history_id} className="relative flex items-start gap-4">
                  <div className="flex items-center justify-center w-8 h-8 rounded-full border-2 border-white bg-red-100 text-[#D32F2F] shrink-0 shadow-sm z-10">
                    <span className="text-[10px] font-black">{log.operator_name.charAt(0).toUpperCase()}</span>
                  </div>
                  
                  <div className="flex-1 bg-white p-3 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow relative z-20">
                    <div className="flex justify-between items-start mb-1">
                      <p className="text-xs font-bold text-gray-900 truncate pr-2">{log.operator_name}</p>
                      <span className="text-[9px] text-gray-500 font-mono font-bold whitespace-nowrap bg-gray-100 border border-gray-200 px-1.5 py-0.5 rounded shrink-0">
                    ...
                    <p className="text-[11px] text-gray-600 mb-2 break-words leading-tight">
                      applied <span className="font-bold text-[#D32F2F]">"{log.action_type}"</span> to <span className="font-semibold text-gray-800">`{log.document_title}`</span>
                    </p>
                    
                    <div className="inline-flex items-center gap-1 text-[10px] text-gray-600 font-mono font-medium bg-gray-50 border border-gray-100 p-1 rounded max-w-full">
...
=======
                <div className="relative z-10 flex flex-col items-center justify-center py-8 bg-white rounded-xl border border-dashed border-gray-300 shadow-sm">
                  <svg className="w-8 h-8 text-gray-400 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" /></svg>
                  <p className="text-xs font-bold text-gray-600">No recent transactions</p>
>>>>>>> parent of f29a6a1 (UI/UX modifications)
                </div>
              )}
            </div>
...
=======
        ...
        <div className="w-[85vw] sm:w-80 md:w-auto md:flex-1 shrink-0 flex flex-col bg-white rounded-xl border border-gray-200 overflow-hidden transition-opacity snap-start">
          <div className="p-3 border-b border-red-200 bg-red-50/80 shrink-0">
            <h4 className="text-xs font-black text-gray-900 flex items-center gap-1.5 uppercase tracking-wide">
              <svg className="w-4 h-4 text-[#D32F2F]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" /></svg>
>>>>>>> parent of f29a6a1 (UI/UX modifications)
              Congestion Alerts
            </h4>
...
=======
          <div className="p-3 overflow-y-auto custom-scrollbar flex-1 space-y-3 bg-gray-50/50">
            {data.stalledBottlenecks.map((item, index) => (
              <div key={index} className="bg-white p-3 border-l-4 border-l-[#D32F2F] border-y border-r border-gray-200 rounded-r-lg shadow-sm hover:shadow-md transition-all group">
                <div className="flex justify-between items-start mb-2">
                  <span className="text-xs font-bold text-gray-900 truncate pr-2 group-hover:text-[#D32F2F] transition-colors">{item.document_title}</span>
                  <span className="text-[9px] bg-red-100 border border-red-200 text-[#D32F2F] font-black px-1.5 py-0.5 rounded font-mono whitespace-nowrap shadow-sm shrink-0">
>>>>>>> parent of f29a6a1 (UI/UX modifications)
...
=======
                <div className="space-y-1.5">
                  <p className="text-[11px] text-gray-700 flex items-center gap-1 max-w-full">
                    <svg className="w-3 h-3 text-gray-500 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                    <span className="font-bold text-gray-900 truncate">{item.office_name}</span>
                  </p>
                  <p className="text-[9px] text-gray-500 font-mono font-semibold flex items-center gap-1 bg-gray-50 p-1 rounded border border-gray-100 max-w-fit">
...
=======
              <div className="flex flex-col items-center justify-center h-full text-center py-10 bg-white rounded-xl border border-gray-200 shadow-sm">
                ...
                <p className="text-xs font-black text-emerald-800 uppercase tracking-wide">Pipelines Nominal</p>
>>>>>>> parent of f29a6a1 (UI/UX modifications)
              </div>
            )}
          </div>
