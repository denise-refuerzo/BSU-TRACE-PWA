...
export default function ProcessorHistoryTab({
  ...
  return (
    <div className="space-y-6 max-w-8xl mx-auto text-left animate-in fade-in duration-200">
      ...
      {/* HEADER SECTION */}
      <div>
        <h2 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Office Transaction History</h2>
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Audit log of all processing events inside your office sector.</p>
      </div>
          ...
          {filteredHistoryLogs.length === 0 && (
            <div className="p-12 text-center bg-gray-50 dark:bg-[#1c1113]">
              <div className="flex flex-col items-center justify-center">
                <svg className="w-8 h-8 text-gray-300 dark:text-gray-600 mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
                <p className="text-sm font-bold text-gray-600 dark:text-gray-400">No tracking entries match</p>
