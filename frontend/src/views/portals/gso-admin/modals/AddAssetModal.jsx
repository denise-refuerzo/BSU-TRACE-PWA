    ...
    <div className="fixed inset-0 bg-neutral-950/40 backdrop-blur-xs flex items-center justify-center p-4 z-[120] animate-in fade-in duration-150">
      <div className="bg-white dark:bg-[#180e10] w-full max-w-md rounded-2xl shadow-2xl border border-neutral-200 dark:border-[#42292f] overflow-hidden flex flex-col text-left">
        <div className="p-4 border-b border-neutral-200 dark:border-[#42292f] bg-[#FDFBF9] dark:bg-[#1c1113] flex items-center justify-between">
          <h3 className="font-bold text-neutral-900 dark:text-white text-sm">Add New Institutional Asset</h3>
          <button onClick={() => setShowAddAssetModal(false)} className="text-neutral-400 dark:text-gray-400 hover:text-neutral-600 dark:hover:text-gray-200 cursor-pointer"><X size={16} /></button>
        </div>
        ...
        <form onSubmit={handleAddAssetSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <select 
              ...
              className="w-full px-4 py-2 text-xs border border-neutral-300 dark:border-gray-700 rounded-lg focus:ring-1 focus:ring-red-700 outline-none bg-white dark:bg-[#1c1113] text-neutral-900 dark:text-white font-medium cursor-pointer"
            >
          ...
          <div className="flex items-start gap-2.5 pt-4">
            <input 
              ...
              className="mt-0.5 rounded text-red-800 focus:ring-red-700 w-3.5 h-3.5 cursor-pointer" 
            />
            <label htmlFor="assetConfirm" className="text-[11px] font-medium text-gray-500 dark:text-gray-400 leading-tight cursor-pointer">
          ...
          <div className="flex justify-between gap-3 pt-6 border-t border-neutral-100 dark:border-[#42292f] mt-2">
            <button type="button" onClick={() => setShowAddAssetModal(false)} className="w-1/2 py-2.5 border border-neutral-300 dark:border-gray-700 bg-white dark:bg-[#180e10] rounded-xl font-bold text-xs text-gray-500 dark:text-gray-300 hover:bg-neutral-50 dark:hover:bg-gray-800 uppercase tracking-wide cursor-pointer">Cancel</button>
            <button type="submit" className="w-1/2 py-2.5 bg-red-800 dark:bg-red-700 hover:bg-red-900 dark:hover:bg-red-800 text-white font-bold rounded-xl shadow-xs uppercase tracking-wide text-xs cursor-pointer">Add Asset</button>
          </div>
        </form>
      </div>
    </div>
