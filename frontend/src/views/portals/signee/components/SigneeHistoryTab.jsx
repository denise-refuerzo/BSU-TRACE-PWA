...
export default function SigneeHistoryTab({
  historyFilter,
  setHistoryFilter,
  setHistoryPage,
  search,
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="relative">
            ...
            <input 
              ...
              className="pl-9 pr-4 py-2 text-xs border border-neutral-300 rounded-lg outline-none w-56 bg-neutral-50 font-medium" 
            />
          </div>
        </div>
      </div>
              ...
              return (
                <tr key={log.history_id || index} className="hover:bg-neutral-50/70 transition-colors">
                  ...
                  <td className="p-4 text-center">
                    <button onClick={() => handleOpenDetails(log, true)} className="p-1.5 hover:bg-neutral-100 rounded-lg text-red-800 inline-flex items-center">
                      <Eye size={16} />
                    </button>
                  </td>
                </tr>
