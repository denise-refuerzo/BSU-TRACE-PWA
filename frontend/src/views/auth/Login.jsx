...
export default function Login() {
  ...
  return (
    <div className="min-h-screen w-full bg-gray-50 dark:bg-[#180e10] flex font-sans antialiased selection:bg-[#D32F2F] selection:text-white relative">
      
      {/* FIXED BOTTOM-RIGHT THEME TOGGLE BUTTON */}
      <div className="fixed bottom-5 right-5 z-[150] bg-white/80 dark:bg-[#1c1113]/80 backdrop-blur-md p-1.5 rounded-full border border-gray-200 dark:border-[#42292f] shadow-lg">
        <ThemeToggle />
      </div>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 transition-opacity duration-300">  
          <div className="bg-white dark:bg-[#180e10] border border-gray-200 dark:border-[#42292f] p-8 rounded-2xl shadow-2xl max-w-sm w-full text-center space-y-6 transform transition-all scale-100">  
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">Enter the 6-digit OTP code sent to your university email.</p>  
            </div>
            {error && <div className="p-3 bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-300 text-sm rounded-lg border border-red-100 dark:border-red-900">{error}</div>}  
            <form onSubmit={handleVerifyOTP} className="space-y-5">  
              <input 
                ...
                placeholder="000000" 
                className="w-full border border-gray-300 dark:border-gray-700 bg-white dark:bg-[#1c1113] text-gray-900 dark:text-white px-4 py-3 text-center font-mono text-2xl tracking-[0.5em] rounded-xl focus:border-[#D32F2F] focus:ring-2 focus:ring-red-100 focus:outline-none transition-all" 
              />
              ...
              <div className="flex gap-3 pt-2">  
                <button 
                  ...
                  className="w-1/2 border border-gray-300 dark:border-gray-700 bg-white dark:bg-[#180e10] py-2.5 text-sm font-medium text-gray-600 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors cursor-pointer"
                >
                  Cancel
                </button>  
                <button 
                  type="submit" 
                  disabled={isSubmitting}
                  className="w-1/2 bg-[#D32F2F] dark:bg-red-700 hover:bg-[#b71c1c] dark:hover:bg-red-800 text-white text-sm font-medium rounded-lg py-2.5 transition-colors shadow-md disabled:opacity-70 flex justify-center items-center cursor-pointer"
                >
                  {isSubmitting ? (
      ...
      {showTerms && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 transition-opacity duration-300">
          <div className="bg-white dark:bg-[#180e10] border border-gray-200 dark:border-[#42292f] rounded-2xl shadow-2xl max-w-2xl w-full max-h-[85vh] flex flex-col overflow-hidden transform transition-all scale-100">
            
            <div className="bg-gray-50 dark:bg-[#1c1113] border-b border-gray-200 dark:border-[#42292f] py-5 px-6 shrink-0 flex items-center gap-4">
              <img src="/bsu-logo.png" alt="BSU" className="h-10 w-auto" />
              <div>
                <h2 className="text-xl font-bold text-gray-900 dark:text-white">BSU-Trace Terms & Conditions</h2>
                <p className="text-xs text-[#D32F2F] dark:text-red-400 font-semibold uppercase tracking-wider mt-0.5">Smart Campus Resource Management System</p>
              </div>
            </div>

            <div className="overflow-y-auto flex-1 p-6 sm:p-8 space-y-6 text-sm text-gray-600 dark:text-gray-300 leading-relaxed custom-scrollbar">
              <section>
                <h3 className="text-base font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2">
                  <span className="w-6 h-6 rounded-full bg-red-100 dark:bg-red-900/40 text-[#D32F2F] dark:text-red-300 flex items-center justify-center text-xs">1</span>
              ...
              <section>
                <h3 className="text-base font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2">
                  <span className="w-6 h-6 rounded-full bg-red-100 dark:bg-red-900/40 text-[#D32F2F] dark:text-red-300 flex items-center justify-center text-xs">2</span>
              ...
              <section>
                <h3 className="text-base font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2">
                  <span className="w-6 h-6 rounded-full bg-red-100 dark:bg-red-900/40 text-[#D32F2F] dark:text-red-300 flex items-center justify-center text-xs">3</span>
              ...
              <section>
                <h3 className="text-base font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2">
                  <span className="w-6 h-6 rounded-full bg-red-100 dark:bg-red-900/40 text-[#D32F2F] dark:text-red-300 flex items-center justify-center text-xs">4</span>
                ...
                <div className="pl-8 text-justify">
                  ...
                  <ul className="list-disc pl-5 space-y-2 text-gray-600 dark:text-gray-300 marker:text-[#D32F2F]">
                    ...
                    <li>All digital resource reservations remain in a <em className="font-semibold text-gray-800 dark:text-gray-200">provisional state</em> until hard-copy documents with required "wet signatures" are physically verified by the General Services Office (GSO).</li>
              ...
              <section>
                <h3 className="text-base font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-2">
                  <span className="w-6 h-6 rounded-full bg-red-100 dark:bg-red-900/40 text-[#D32F2F] dark:text-red-300 flex items-center justify-center text-xs">5</span>
                  User Consent
                </h3>
            ...
            <div className="flex gap-4 p-5 border-t border-gray-200 dark:border-[#42292f] shrink-0 bg-white dark:bg-[#180e10] shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
              <button 
                type="button" 
                onClick={() => {
                  setShowTerms(false);
                ...
                className="w-1/2 border border-gray-300 dark:border-gray-700 bg-white dark:bg-[#180e10] py-3 text-sm font-bold text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors uppercase tracking-wider cursor-pointer"
              >
                Decline
              </button>
              ...
              <button 
                ...
                className="w-1/2 bg-[#D32F2F] dark:bg-red-700 hover:bg-[#b71c1c] dark:hover:bg-red-800 shadow-md text-white text-sm font-bold rounded-lg py-3 transition-colors uppercase tracking-wider cursor-pointer"
              >
                Accept & Continue
              </button>
            </div>
      ...
      {showForgotModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 transition-opacity duration-300">
          <div className="bg-white dark:bg-[#180e10] border border-gray-200 dark:border-[#42292f] rounded-2xl shadow-2xl max-w-lg w-full overflow-hidden transform transition-all scale-100">
            
            <div className="flex justify-between items-center px-6 py-4 border-b border-gray-100 dark:border-[#42292f] bg-gray-50 dark:bg-[#1c1113]">
              <h3 className="text-lg font-bold text-gray-900 dark:text-white">Account Recovery</h3>
              <button 
                onClick={closeForgotModal} 
                className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 transition-colors p-1 rounded-full hover:bg-gray-200 dark:hover:bg-gray-800 cursor-pointer"
              >
            ...
            <div className="p-6 sm:p-8">
              ...
              <div className="flex items-center justify-center mb-8">
                {[1, 2, 3, 4].map((step) => (
                  <React.Fragment key={step}>
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold ${forgotStep >= step ? 'bg-[#D32F2F] text-white' : 'bg-gray-100 dark:bg-gray-800 text-gray-400 dark:text-gray-500'}`}>
                    ...
                    {step < 4 && (
                      <div className={`w-12 h-1 ${forgotStep > step ? 'bg-[#D32F2F]' : 'bg-gray-100 dark:bg-gray-800'}`} />
                    )}
                  </React.Fragment>
                ))}
              </div>
              ...
              <div className="space-y-6">
                ...
                {forgotError && (
                  <div className="p-3 bg-red-50 dark:bg-red-900/30 text-red-700 dark:text-red-300 text-sm rounded-lg border border-red-200 dark:border-red-800 flex items-start gap-2">
                ...
                {forgotStep === 1 && (
                  <form onSubmit={handleIdentifyUser} className="space-y-5">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">University Username</label>
                      <input 
                        type="text" 
                        required 
                        ...
                        className="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-700 bg-white dark:bg-[#1c1113] text-gray-900 dark:text-white rounded-lg text-sm focus:border-[#D32F2F] focus:ring-1 focus:ring-[#D32F2F] outline-none transition-all"
                      />
                    </div>
                    <button 
                      type="submit" 
                      disabled={isSubmitting}
                      className="w-full bg-[#D32F2F] dark:bg-red-700 hover:bg-[#b71c1c] dark:hover:bg-red-800 text-white text-sm font-bold py-3 rounded-lg shadow-md transition-colors disabled:opacity-70 flex justify-center items-center cursor-pointer"
                    >
                ...
                {forgotStep === 2 && (
                  <form onSubmit={handleVerifyEmail} className="space-y-5">
                    ...
                    <div className="bg-gray-50 dark:bg-[#1c1113] border border-gray-200 dark:border-gray-700 rounded-lg p-3 text-center">
                      <span className="text-base font-mono font-bold text-gray-800 dark:text-gray-200">{maskedEmail}</span>
                    </div>
                    <div>
                      <input 
                        type="email" 
                ...
                {forgotStep === 3 && (
                  <form onSubmit={handleResetPassword} className="space-y-5">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">6-Digit Verification Code</label>
                      <input 
                        type="text" 
                        maxLength={6} 
                        required 
                        ...
                        placeholder="000000" 
                        className="w-full px-4 py-3 text-center font-mono font-bold text-lg tracking-[0.5em] border border-gray-300 dark:border-gray-700 bg-white dark:bg-[#1c1113] text-gray-900 dark:text-white rounded-lg focus:border-[#D32F2F] focus:ring-1 focus:ring-[#D32F2F] outline-none transition-all"
                      />
                    </div>
                    <div>
                      ...
                      <div className="relative flex items-center">
                        <input 
                          ...
                          placeholder="••••••••" 
                          className="w-full pl-4 pr-10 py-2.5 border border-gray-300 dark:border-gray-700 bg-white dark:bg-[#1c1113] text-gray-900 dark:text-white rounded-lg text-sm focus:border-[#D32F2F] focus:ring-1 focus:ring-[#D32F2F] outline-none transition-all"
                        />
                        <button
                          type="button"
                    ...
                    <button 
                      type="submit" 
                      disabled={isSubmitting}
                      className="w-full bg-[#D32F2F] dark:bg-red-700 hover:bg-[#b71c1c] dark:hover:bg-red-800 text-white text-sm font-bold py-3 rounded-lg shadow-md transition-colors disabled:opacity-70 flex justify-center items-center cursor-pointer mt-6"
                    >
                ...
                {forgotStep === 4 && (
                  <div className="text-center py-6 space-y-5">
                    ...
                    <h4 className="text-lg font-bold text-gray-900 dark:text-white">Password Reset Successful</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-300 px-4">{forgotSuccess}</p>
                    <button 
                      type="button" 
                      onClick={closeForgotModal} 
                      className="w-full bg-[#D32F2F] dark:bg-red-700 hover:bg-[#b71c1c] dark:hover:bg-red-800 text-white text-sm font-bold py-3 rounded-lg shadow-md transition-colors mt-4 cursor-pointer"
                    >
                      Return to Sign In
                    </button>
                  </div>
      ...
      <div className="w-full flex">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative bg-white dark:bg-[#180e10]">
          
          {/* Mobile Header (Only shows when left side is hidden) */}
          <div className="absolute top-8 left-8 right-8 flex lg:hidden items-center gap-3 border-b border-gray-100 dark:border-[#42292f] pb-4">
            <img src="/bsu-logo.png" alt="BSU Logo" className="h-10 w-auto" />
            <div>
              <h1 className="text-lg font-bold text-gray-900 dark:text-white leading-tight uppercase">BSU-Trace</h1>
              <p className="text-xs text-[#D32F2F] dark:text-red-400 font-semibold">Batangas State University</p>
            </div>
          </div>
          ...
          <div className="w-full max-w-md mt-16 lg:mt-0">
            ...
            {error && !require2FA && (
              <div className="mb-6 p-4 bg-red-50 dark:bg-red-900/30 text-red-700 dark:text-red-300 text-sm rounded-xl border border-red-200 dark:border-red-800 flex items-start gap-3 shadow-sm">
                <svg className="w-5 h-5 shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                <span>{error}</span>
              </div>
            )}
            ...
            <form onSubmit={handleSignIn} className="space-y-6">
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full pl-10 pr-4 py-3.5 bg-gray-50 dark:bg-[#1c1113] border border-gray-200 dark:border-gray-700 rounded-xl text-sm text-gray-900 dark:text-white focus:bg-white dark:focus:bg-[#180e10] focus:outline-none focus:border-[#D32F2F] focus:ring-1 focus:ring-[#D32F2F] transition-all shadow-sm"
                  />
                </div>
              </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button 
                    ...
                    className="text-xs font-semibold text-[#D32F2F] dark:text-red-400 hover:text-[#b71c1c] dark:hover:text-red-300 transition-colors cursor-pointer"
                  >
                    Forgot password?
                  </button>
                </div>
                <div className="relative">
                  ...
                  <input 
                    ...
                    required
                    placeholder="••••••••" 
                    className="w-full pl-10 pr-12 py-3.5 bg-gray-50 dark:bg-[#1c1113] border border-gray-200 dark:border-gray-700 rounded-xl text-sm text-gray-900 dark:text-white focus:bg-white dark:focus:bg-[#180e10] focus:outline-none focus:border-[#D32F2F] focus:ring-1 focus:ring-[#D32F2F] transition-all shadow-sm"
                  />
                  <button
                    type="button"
                    onClick={() => setShowSignInPassword(!showSignInPassword)}  
                    className="absolute inset-y-0 right-0 pr-4 flex items-center text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 transition-colors focus:outline-none cursor-pointer"
                    tabIndex={-1}
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      {showSignInPassword ? (
              ...
              <div className="pt-2">
                <button 
                  type="submit" 
                  disabled={isSubmitting}
                  className="w-full bg-[#D32F2F] dark:bg-red-700 hover:bg-[#b71c1c] dark:hover:bg-red-800 text-white font-bold text-base py-3.5 rounded-xl shadow-[0_4px_14px_0_rgba(211,47,47,0.39)] hover:shadow-[0_6px_20px_rgba(211,47,47,0.23)] hover:-translate-y-0.5 transition-all duration-200 disabled:opacity-70 disabled:hover:translate-y-0 disabled:shadow-none flex justify-center items-center gap-2 cursor-pointer"
                >
                  {isSubmitting ? (
                    <>
                      <svg className="animate-spin h-5 w-5 text-white" fill="none" viewBox="0 0 24 24"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
            ...
            <div className="mt-10 text-center">
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Need help? <a href="mailto:helpdesk@g.batstate-u.edu.ph" className="font-semibold text-[#D32F2F] dark:text-red-400 hover:underline">Contact IT Support</a>
              </p>
            </div>
          </div>
